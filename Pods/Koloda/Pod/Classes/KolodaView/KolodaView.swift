...
open class KolodaView: UIView, DraggableCardDelegate {
    ...
    open func frameForCard(at index: Int) -> CGRect {
        ...
        let xOffset = (self.frame.width - width) / 2 * 1.7
        ...
        let yOffset = (prevCardFrame.height - height + prevCardFrame.origin.y + defaultBackgroundCardsTopMargin) * multiplier * 0.65
