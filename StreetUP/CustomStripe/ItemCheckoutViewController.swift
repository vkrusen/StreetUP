//
//  ItemCheckoutViewController.swift
//  StreetUP
//
...
class ItemCheckoutViewController: UIViewController, STPPaymentContextDelegate {
    
    @IBOutlet var titleLabel: UILabel!
    @IBOutlet var priceLabel: UILabel!
    
    let publishableKey = "pk_test_Ka3iOze1vZHU9h3X355IqRTw"
    ...
    let backendBaseURL: String? = "https://streetupapp.herokuapp.com/"
...
extension ItemCheckoutViewController: STPAddCardViewControllerDelegate {
    ...
    func addCardViewController(_ addCardViewController: STPAddCardViewController, didCreateToken token: STPToken, completion: @escaping STPErrorBlock) {
        StripeClient.shared.completeCharge(with: token, amount: ItemCheckoutChart.shared.total) { result in
            switch result {
            // 1
            case .success:
                completion(nil)
